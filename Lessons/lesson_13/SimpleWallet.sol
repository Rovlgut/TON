...
contract SimpleWallet {
    ...
    uint256 public m_secondPubkey;
    uint256 public m_tvmPubkey;
    ...
    function getMsgPubKey() public returns (uint) {
        tvm.accept();
        return msg.pubkey();
    }

    function getTvmPubKey() public returns (uint) {
        tvm.accept();
        return tvm.pubkey();
    }
