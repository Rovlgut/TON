...
contract Datatypes {
    ...
    constructor() public {
        ...
        byte myOnlyOneNyte = 'a';
        byte[] bytesArray;
        bytes anotherBytesArray = "abcdefg";

        anotherBytesArray.length;
        bytes slice = anotherBytesArray[1:3];

        string simpleString = "dsfasdfsd";
        simpleString.substr(1, 5);
        simpleString.append("sample1");
        simpleString.findLast(byte('d'));
        stoi(simpleString);
        ...
        assocArray["pasport768764"] = "Ivan Sidorov";
